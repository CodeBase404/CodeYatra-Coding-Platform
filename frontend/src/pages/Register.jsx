  ...
  return (
    <div className="pt-41 relative flex items-center justify-center h-screen mx-2">
      <form
        ...
        className="flex flex-col justify-center gap-4 bg-white dark:bg-white/5 backdrop-blur-lg border border-gray-500/20 min-h-[66%] w-full max-w-md mx-2 md:mx-auto p-6 shadow rounded-3xl"
      >
      ...
      <div className="absolute top-20 w-110">
